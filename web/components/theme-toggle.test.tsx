...
describe("ThemeToggle", () => {
  ...
  beforeEach(() => {
    ...
    mockUseSyncExternalStore.mockImplementation((_subscribe, getSnapshot) => getSnapshot());
  });
  ...
  it("renders an inactive placeholder button before mount (avoids hydration mismatch)", () => {
    mockUseSyncExternalStore.mockImplementation((_subscribe, _getSnapshot, getServerSnapshot) =>
